      ...
      <article class="ancestry">
        <dl class="m-listContainer">
          ...
          <dt class="m-listContainer--dtstyle">Lucy A. Thompson</dt>
            <dd class="m-listContainer--ddstyle">Until very recently we knew next to nothing about Ms Thompson. A very similar case as the Hunt's family presented. <br>
